...
RSpec.describe Public::CategoriesController, type: :controller do
  describe 'GET #posts' do
    ...
    let!(:post1) { create(:post, category: category, created_at: 3.days.ago, favorite_count: 5, comments_count: 3) }
    let!(:post2) { create(:post, category: category, created_at: 2.days.ago, favorite_count: 2, comments_count: 5) }
    let!(:post3) { create(:post, category: category, created_at: 1.day.ago, favorite_count: 8, comments_count: 1) }
